export const USER_PROGRAMS = [
  {
    ...
    workout_plan: {
      ...
      description:
        "This program focuses on building a consistent exercise habit with joint-friendly movements that protect your lower back while supporting weight loss.",
    },
    diet_plan: {
  ...
  },
  {
    ...
    workout_plan: {
      ...
      description:
        "This program implements a traditional body-part split with emphasis on progressive overload to maximize muscle growth and strength development.",
    },
    diet_plan: {
  ...
  },
  {
    ...
    workout_plan: {
      title: "Advanced Functional Fitness & Mobility Program",
      weekly_schedule: [
      ...
      description:
        "This program focuses on functional movement patterns that improve everyday performance while being gentle on the knees and supporting overall health.",
    },
    diet_plan: {
