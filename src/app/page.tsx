            ...
            <div className="space-y-8 relative text-center flex flex-col items-center">
              ...
              <div className="flex items-center justify-center gap-10 py-6 font-mono">
                <div className="flex flex-col group cursor-default">
                  <div className="text-2xl text-primary group-hover:scale-110 transition-transform duration-200">500+</div>
                  <div className="text-xs uppercase tracking-wider">ACTIVE USERS</div>
                </div>
                <div className="h-12 w-px bg-gradient-to-b from-transparent via-border to-transparent"></div>
                <div className="flex flex-col group cursor-default">
                  <div className="text-2xl text-primary group-hover:scale-110 transition-transform duration-200">3min</div>
                  <div className="text-xs uppercase tracking-wider">GENERATION</div>
                </div>
                <div className="h-12 w-px bg-gradient-to-b from-transparent via-border to-transparent"></div>
                <div className="flex flex-col group cursor-default">
                  <div className="text-2xl text-primary group-hover:scale-110 transition-transform duration-200">100%</div>
              ...
              <div className="pt-6">
                ...
                >
                  <Link href={"/generate-program"} className="flex items-center font-mono group">
                    Build Your Program
